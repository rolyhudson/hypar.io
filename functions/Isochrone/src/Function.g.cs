...
namespace Isochrone
{
    public class Function
    {
        ...
        private IModelStore<IsochroneInputs> store;

        public async Task<IsochroneOutputs> Handler(IsochroneInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<IsochroneInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
            }

            var l = new InvocationWrapper<IsochroneInputs,IsochroneOutputs>(store, Isochrone.Execute);
